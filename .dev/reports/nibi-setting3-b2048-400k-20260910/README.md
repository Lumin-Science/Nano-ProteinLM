...
**All evaluations through 310k passed independent local verification; the 310k evaluation completed September 11 at 4:05 AM Toronto.** Training continued normally; the audited metric snapshot reaches step 310050. The 200k and 300k durable checkpoints and their completed exact model/optimizer restoration audits remain preserved. The finish estimate remains September 11 around 4 p.m. Toronto, before the allocation expires September 14 at 7:24 a.m.
...
From 300k to 310k, validation loss changed **-0.002443** and P@L changed **+0.127 percentage points**. Relative to the 100k parent, validation loss is **0.056839 lower** and P@L is **4.841 points higher**; the paired chain-bootstrap interval for the latter gain is **4.772–4.914 points**. These intervals measure variation across the same 20,775 contact chains, not across training seeds. All 21 continuation endpoints have independently verified component hashes, chain identities, probe settings, checkpoint bindings and 5,000 bootstrap replicates.

The global training objective averaged 2.257506 over 290k–300k and 2.255508 over 300k–310k, with mean gradient norms 0.092013 and 0.092751. The latest interval averaged 0.447 seconds per training update. The historical resume investigation remains unchanged.

See the [110k audit](full/evaluations/step-110000/LOCAL_AUDIT.json), [120k audit](full/evaluations/step-120000/LOCAL_AUDIT.json), [130k audit](full/evaluations/step-130000/LOCAL_AUDIT.json), [140k audit](full/evaluations/step-140000/LOCAL_AUDIT.json), [150k audit](full/evaluations/step-150000/LOCAL_AUDIT.json), [160k audit](full/evaluations/step-160000/LOCAL_AUDIT.json), [170k audit](full/evaluations/step-170000/LOCAL_AUDIT.json), [180k audit](full/evaluations/step-180000/LOCAL_AUDIT.json), [190k audit](full/evaluations/step-190000/LOCAL_AUDIT.json), [200k audit](full/evaluations/step-200000/LOCAL_AUDIT.json), [210k audit](full/evaluations/step-210000/LOCAL_AUDIT.json), [220k audit](full/evaluations/step-220000/LOCAL_AUDIT.json), [230k audit](full/evaluations/step-230000/LOCAL_AUDIT.json), [240k audit](full/evaluations/step-240000/LOCAL_AUDIT.json), [250k audit](full/evaluations/step-250000/LOCAL_AUDIT.json), [260k audit](full/evaluations/step-260000/LOCAL_AUDIT.json), [270k audit](full/evaluations/step-270000/LOCAL_AUDIT.json), [280k audit](full/evaluations/step-280000/LOCAL_AUDIT.json), [290k audit](full/evaluations/step-290000/LOCAL_AUDIT.json), [300k audit](full/evaluations/step-300000/LOCAL_AUDIT.json), [310k audit](full/evaluations/step-310000/LOCAL_AUDIT.json), [machine-readable curve](learning-curve.json), and [local evaluation verifier](verify_evaluation.py). All earlier audited results are retained.

At 310k, source accounting is mgnify: epoch 0, 0 repeated draws, omg_img: epoch 1, 76,619,485 repeated draws, uniref90: epoch 3, 152,083,098 repeated draws. Permitted source reuse occurs only after completing a global pass; MGnify remains unrepeated. The checkpoint contains 634,880,000 total sequence draws and 149,963,310,158 non-padding model tokens; all source histories and counts remain consistent with the retained 100k history.
