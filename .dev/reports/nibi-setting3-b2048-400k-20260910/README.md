...
**All evaluations through 260k passed independent local verification; the 260k evaluation completed September 10 at 9:33 PM Toronto.** Training continued normally; the audited metric snapshot reaches step 263900. The 200k durable checkpoint and its completed exact model/optimizer restoration audit remain preserved. The finish estimate remains September 11 around 4 p.m. Toronto, before the allocation expires September 14 at 7:24 a.m.
...
From 250k to 260k, validation loss changed **+0.001051** and P@L changed **+0.056 percentage points**. Relative to the 100k parent, validation loss is **0.045293 lower** and P@L is **4.033 points higher**; the paired chain-bootstrap interval for the latter gain is **3.968–4.102 points**. These intervals measure variation across the same 20,775 contact chains, not across training seeds. All 16 continuation endpoints have independently verified component hashes, chain identities, probe settings, checkpoint bindings and 5,000 bootstrap replicates.

The global training objective averaged 2.266260 over 240k–250k and 2.263842 over 250k–260k, with mean gradient norms 0.090817 and 0.091254. The latest interval averaged 0.447 seconds per training update. The historical resume investigation remains unchanged.
...
At 260k, source accounting is mgnify: epoch 0, 0 repeated draws, omg_img: epoch 1, 21,866,335 repeated draws, uniref90: epoch 2, 115,595,418 repeated draws. Permitted source reuse occurs only after completing a global pass; MGnify remains unrepeated. The checkpoint contains 532,480,000 total sequence draws and 125,775,876,061 non-padding model tokens; all source histories and counts remain consistent with the retained 100k history.
