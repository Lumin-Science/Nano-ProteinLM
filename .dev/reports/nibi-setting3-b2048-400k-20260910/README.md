# Nibi Setting 3 continuation: completed 400k Stage-1 steps

**The authorized 400,000-step run completed September 11 at 3:50 p.m. Toronto.** All 30 continuation evaluations and the final durable checkpoint passed independent verification. Production step 12162637.32 exited successfully after 39h 13m 50s, including evaluations and preservation. The user-owned allocation remains available until September 14 at 7:24 a.m.; no additional training was launched.
...
| 220,000 | 2.336921 | 40.212% | 39.967–40.466% |
| 230,000 | 2.334325 | 40.056% | 39.810–40.310% |
| 240,000 | 2.329800 | 40.464% | 40.219–40.719% |
| 250,000 | 2.329357 | 40.544% | 40.302–40.801% |
| 260,000 | 2.330408 | 40.600% | 40.352–40.853% |
| 270,000 | 2.324499 | 40.868% | 40.620–41.123% |
| 280,000 | 2.324704 | 41.008% | 40.759–41.260% |
| 290,000 | 2.322593 | 41.251% | 41.002–41.504% |
| 300,000 | 2.321305 | 41.282% | 41.036–41.535% |
| 310,000 | 2.318862 | 41.409% | 41.162–41.662% |
| 320,000 | 2.318896 | 41.618% | 41.374–41.873% |
| 330,000 | 2.317108 | 41.716% | 41.470–41.971% |
| 340,000 | 2.315456 | 41.716% | 41.467–41.975% |
| 350,000 | 2.314411 | 41.824% | 41.576–42.080% |
| 360,000 | 2.310890 | 41.892% | 41.642–42.148% |
| 370,000 | 2.311364 | 41.972% | 41.724–42.224% |
| 380,000 | 2.310977 | 41.987% | 41.740–42.239% |
| 390,000 | 2.309562 | 42.280% | 42.034–42.534% |
| **400,000** | **2.308892** | **42.241%** | **41.992–42.495%** |

The final **400k** checkpoint has the lowest validation loss, **2.308892**. The highest measured P@L is **42.280% at 390k**; the final value is **42.241%**, a change of **-0.039 percentage points**. Validation loss changed **-0.000669** over the same interval. Relative to the 100k parent, final validation loss is **0.066809 lower** and P@L is **5.673 points higher**; the paired chain-bootstrap interval for the latter gain is **5.599–5.753 points**. These intervals measure variation across the same 20,775 contact chains, not across training seeds.

The global training objective averaged 2.245311 over 380k–390k and 2.244112 over 390k–400k, with mean gradient norms 0.095337 and 0.095312. The latest interval averaged 0.446 seconds per training update. The historical resume investigation remains unchanged.

The [completion audit](COMPLETION_AUDIT.json) binds the final model/optimizer restoration, scheduler exit, all 30 independently verified evaluations and source histories. The [scheduler receipt](full/SCHEDULER_STATUS.json), [training completion receipt](full/TRAINING_COMPLETE.json) and [completion marker](full/COMPLETE.txt) record the actual endpoint. The 400k evaluation ran separately after training; its wall time was not recorded by an EVALUATION_RUN timer, and the retained periodic receipt belongs to 390k.

See the [110k audit](full/evaluations/step-110000/LOCAL_AUDIT.json), [120k audit](full/evaluations/step-120000/LOCAL_AUDIT.json), [130k audit](full/evaluations/step-130000/LOCAL_AUDIT.json), [140k audit](full/evaluations/step-140000/LOCAL_AUDIT.json), [150k audit](full/evaluations/step-150000/LOCAL_AUDIT.json), [160k audit](full/evaluations/step-160000/LOCAL_AUDIT.json), [170k audit](full/evaluations/step-170000/LOCAL_AUDIT.json), [180k audit](full/evaluations/step-180000/LOCAL_AUDIT.json), [190k audit](full/evaluations/step-190000/LOCAL_AUDIT.json), [200k audit](full/evaluations/step-200000/LOCAL_AUDIT.json), [210k audit](full/evaluations/step-210000/LOCAL_AUDIT.json), [220k audit](full/evaluations/step-220000/LOCAL_AUDIT.json), [230k audit](full/evaluations/step-230000/LOCAL_AUDIT.json), [240k audit](full/evaluations/step-240000/LOCAL_AUDIT.json), [250k audit](full/evaluations/step-250000/LOCAL_AUDIT.json), [260k audit](full/evaluations/step-260000/LOCAL_AUDIT.json), [270k audit](full/evaluations/step-270000/LOCAL_AUDIT.json), [280k audit](full/evaluations/step-280000/LOCAL_AUDIT.json), [290k audit](full/evaluations/step-290000/LOCAL_AUDIT.json), [300k audit](full/evaluations/step-300000/LOCAL_AUDIT.json), [310k audit](full/evaluations/step-310000/LOCAL_AUDIT.json), [320k audit](full/evaluations/step-320000/LOCAL_AUDIT.json), [330k audit](full/evaluations/step-330000/LOCAL_AUDIT.json), [340k audit](full/evaluations/step-340000/LOCAL_AUDIT.json), [350k audit](full/evaluations/step-350000/LOCAL_AUDIT.json), [360k audit](full/evaluations/step-360000/LOCAL_AUDIT.json), [370k audit](full/evaluations/step-370000/LOCAL_AUDIT.json), [380k audit](full/evaluations/step-380000/LOCAL_AUDIT.json), [390k audit](full/evaluations/step-390000/LOCAL_AUDIT.json), [400k audit](full/evaluations/step-400000/LOCAL_AUDIT.json), [machine-readable curve](learning-curve.json), and [local evaluation verifier](verify_evaluation.py). All earlier audited results are retained.

At 400k, source accounting is MGnify: epoch 0, zero repeated draws; OMG/IMG: epoch 1, 175,168,188 permitted repeated draws; UniRef90: epoch 3, 217,790,577 permitted repeated draws. The final checkpoint contains 819,200,000 sequence draws and 193,501,303,973 non-padding model tokens, including the preserved 100k parent history. MGnify consumed 89,220,075 of 90,495,061 prepared records and has 1,274,986 unique records remaining. The planned 400k budget completed without MGnify resampling.

The [durable 200k preservation receipt](milestones/checkpoint-200000.json) records a 1,367,474,348-byte full checkpoint at `/project/def-lsigal/muchenli/Nano-Protein-LM/checkpoints/nibi-setting3-b2048-400k-20260910/checkpoint-200000.pt` with SHA-256 `7dd4227dc8dccdd2b9f786f7c37b6a2b876a6715628b47eb6ee10d90175e9833`. An independent [full model/optimizer restoration audit](milestones/checkpoint-200000-restore-verified.json) verified the saved file hash, exact restoration, finite tensors, eight-rank global sampler state, and all exposure counts on allocated CPUs without interrupting training.

The [durable 300k preservation receipt](milestones/checkpoint-300000.json) records a 1,367,474,348-byte full checkpoint at `/project/def-lsigal/muchenli/Nano-Protein-LM/checkpoints/nibi-setting3-b2048-400k-20260910/checkpoint-300000.pt` with SHA-256 `e85db8727516aa3f8ee278dcab413be527e502d619c2ecc9194dcb4e9838719f`. An independent [full model/optimizer restoration audit](milestones/checkpoint-300000-restore-verified.json) verified the saved file hash, exact restoration, finite tensors, eight-rank global sampler state, and all exposure counts on allocated CPUs without interrupting training.

The [durable 400k preservation receipt](milestones/checkpoint-400000.json) records a 1,367,474,089-byte full checkpoint at `/project/def-lsigal/muchenli/Nano-Protein-LM/checkpoints/nibi-setting3-b2048-400k-20260910/checkpoint-400000.pt` with SHA-256 `c205ca56a3c8ecd47a5985444d2d012a2a4e5fa38de8b1e58469619b7eff6dc2`. A separate [full model/optimizer restoration audit](milestones/checkpoint-400000-restore-verified.json) independently rehashed the durable file and verified exact restoration, finite tensors, eight-rank global sampler state and all source exposure counts on allocated CPUs. The parent 100k checkpoint remains separately preserved; all scheduled 200k, 300k and 400k durable milestones are complete.
...
Production evaluated every 10k steps from 110k through 400k using the same 4,096 MLM validation sequences and 20,775 contact chains, 16 contact shards and 5,000 chain-bootstrap replicates. Periodic evaluation used four GPUs while the eight training ranks paused; the separate final evaluation ran after training. The scientific protocol was unchanged. The durable 200k/300k/400k checkpoints retain optimizer and global sampler state. Monitoring ran every two hours through completion and is now paused.
...
The existing [100k comparison](../nibi-paired-unique-b2048-100k-20260909/README.md) was published to main at `1c13852`. Later report commits record this launch; they do not mutate the frozen training checkout.
