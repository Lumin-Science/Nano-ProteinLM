...
**All evaluations through 350k passed independent local verification; the 350k evaluation completed September 11 at 9:18 AM Toronto.** Training continued normally; the audited metric snapshot reaches step 356000. The 200k and 300k durable checkpoints and their completed exact model/optimizer restoration audits remain preserved. The finish estimate remains September 11 around 4 p.m. Toronto, before the allocation expires September 14 at 7:24 a.m.
...
From 340k to 350k, validation loss changed **-0.001045** and P@L changed **+0.108 percentage points**. Relative to the 100k parent, validation loss is **0.061290 lower** and P@L is **5.256 points higher**; the paired chain-bootstrap interval for the latter gain is **5.186–5.333 points**. These intervals measure variation across the same 20,775 contact chains, not across training seeds. All 25 continuation endpoints have independently verified component hashes, chain identities, probe settings, checkpoint bindings and 5,000 bootstrap replicates.

The global training objective averaged 2.251348 over 330k–340k and 2.249718 over 340k–350k, with mean gradient norms 0.093542 and 0.093814. The latest interval averaged 0.447 seconds per training update. The historical resume investigation remains unchanged.

See the [110k audit](full/evaluations/step-110000/LOCAL_AUDIT.json), [120k audit](full/evaluations/step-120000/LOCAL_AUDIT.json), [130k audit](full/evaluations/step-130000/LOCAL_AUDIT.json), [140k audit](full/evaluations/step-140000/LOCAL_AUDIT.json), [150k audit](full/evaluations/step-150000/LOCAL_AUDIT.json), [160k audit](full/evaluations/step-160000/LOCAL_AUDIT.json), [170k audit](full/evaluations/step-170000/LOCAL_AUDIT.json), [180k audit](full/evaluations/step-180000/LOCAL_AUDIT.json), [190k audit](full/evaluations/step-190000/LOCAL_AUDIT.json), [200k audit](full/evaluations/step-200000/LOCAL_AUDIT.json), [210k audit](full/evaluations/step-210000/LOCAL_AUDIT.json), [220k audit](full/evaluations/step-220000/LOCAL_AUDIT.json), [230k audit](full/evaluations/step-230000/LOCAL_AUDIT.json), [240k audit](full/evaluations/step-240000/LOCAL_AUDIT.json), [250k audit](full/evaluations/step-250000/LOCAL_AUDIT.json), [260k audit](full/evaluations/step-260000/LOCAL_AUDIT.json), [270k audit](full/evaluations/step-270000/LOCAL_AUDIT.json), [280k audit](full/evaluations/step-280000/LOCAL_AUDIT.json), [290k audit](full/evaluations/step-290000/LOCAL_AUDIT.json), [300k audit](full/evaluations/step-300000/LOCAL_AUDIT.json), [310k audit](full/evaluations/step-310000/LOCAL_AUDIT.json), [320k audit](full/evaluations/step-320000/LOCAL_AUDIT.json), [330k audit](full/evaluations/step-330000/LOCAL_AUDIT.json), [340k audit](full/evaluations/step-340000/LOCAL_AUDIT.json), [350k audit](full/evaluations/step-350000/LOCAL_AUDIT.json), [machine-readable curve](learning-curve.json), and [local evaluation verifier](verify_evaluation.py). All earlier audited results are retained.

At 350k, source accounting is mgnify: epoch 0, 0 repeated draws, omg_img: epoch 1, 120,410,811 repeated draws, uniref90: epoch 3, 181,298,865 repeated draws. Permitted source reuse occurs only after completing a global pass; MGnify remains unrepeated. The checkpoint contains 716,800,000 total sequence draws and 169,315,622,178 non-padding model tokens; all source histories and counts remain consistent with the retained 100k history.
