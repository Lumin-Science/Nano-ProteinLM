...
**All evaluations through 380k passed independent local verification; the 380k evaluation completed September 11 at 1:13 PM Toronto.** Training continued normally; the audited metric snapshot reaches step 386620. The 200k and 300k durable checkpoints and their completed exact model/optimizer restoration audits remain preserved. The finish estimate remains September 11 around 4 p.m. Toronto, before the allocation expires September 14 at 7:24 a.m.
...
From 370k to 380k, validation loss changed **-0.000387** and P@L changed **+0.015 percentage points**. Relative to the 100k parent, validation loss is **0.064724 lower** and P@L is **5.420 points higher**; the paired chain-bootstrap interval for the latter gain is **5.346–5.498 points**. These intervals measure variation across the same 20,775 contact chains, not across training seeds. All 28 continuation endpoints have independently verified component hashes, chain identities, probe settings, checkpoint bindings and 5,000 bootstrap replicates.

The global training objective averaged 2.247826 over 360k–370k and 2.246263 over 370k–380k, with mean gradient norms 0.094863 and 0.094711. The latest interval averaged 0.446 seconds per training update. The historical resume investigation remains unchanged.
...
At 380k, source accounting is mgnify: epoch 0, 0 repeated draws, omg_img: epoch 1, 153,265,791 repeated draws, uniref90: epoch 3, 203,193,560 repeated draws. Permitted source reuse occurs only after completing a global pass; MGnify remains unrepeated. The checkpoint contains 778,240,000 total sequence draws and 183,826,745,346 non-padding model tokens; all source histories and counts remain consistent with the retained 100k history.
...
The parent 100k remains separately preserved. The next durable milestone is 400k.
