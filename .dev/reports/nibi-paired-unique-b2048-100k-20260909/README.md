...
evaluations at 10k, 20k, 30k, 40k and 50k steps are independently audited below.
...
At 50k, both models consumed **102,400,000 distinct training records** and
**24,196,760,732 model tokens**, with matching source draws and zero source wraps.
...
Setting 3 improves validation loss by **0.045729** and P@L by **9.385 percentage
points** at the matched 50k endpoint; the paired chain-bootstrap interval for the
P@L gain is **9.284–9.485 points**. At 10k, 20k, 30k and 40k, the corresponding
P@L gains were 8.419, 9.288, 9.570 and 10.020 points. Both runs continue to 100k.
...
At the September 9, 12:01 p.m. Toronto check, AdamW was at **57,880 steps** and
Setting 3 at **55,530**. Both had fresh finite metrics, zero sampler wraps and no
fatal OOM exceptions or tracebacks. Downloaded source draws and token counts
matched at all 5,559 common logged steps, through step 55,580. Training continued
