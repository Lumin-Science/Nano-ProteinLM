...
The [10k](evaluations/step-010000/RESULT_VERIFIED.json), [20k](evaluations/step-020000/RESULT_VERIFIED.json) and [30k](evaluations/step-030000/RESULT_VERIFIED.json) results passed the fixed evaluation protocol and checkpoint-identity checks; evaluation pauses lasted 228.63, 219.61 and 220.54 seconds, respectively. All three complete model/optimizer checkpoints were hash-verified in project storage. The 30k archive SHA256 is `1f043fcb38f1c4b9169def1556e3eb5d249d7222b55fbd91056401a96cd611a6`. From 20k to 30k, validation loss decreased by 0.02747 and P@L increased by 2.993 percentage points. At 03:25:59 America/Toronto, training had reached 30,940 updates and consumed 31,682,560 unique proteins without repeats. The estimated endpoint remains approximately 87k updates at the unchanged 07:04 training deadline, including observed evaluation overhead; the [03:02 monitor snapshot](evidence/STATUS_20260914T0702Z.json) records the throughput-based estimate separately from completed results.
