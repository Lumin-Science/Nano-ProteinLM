...
The [10k](evaluations/step-010000/RESULT_VERIFIED.json), [20k](evaluations/step-020000/RESULT_VERIFIED.json), [30k](evaluations/step-030000/RESULT_VERIFIED.json), [40k](evaluations/step-040000/RESULT_VERIFIED.json) and [50k](evaluations/step-050000/RESULT_VERIFIED.json) results passed the fixed evaluation protocol and checkpoint-identity checks; evaluation pauses lasted 228.63, 219.61, 220.54, 222.65 and 221.57 seconds, respectively. All five complete model/optimizer checkpoints were hash-verified in project storage. The 50k archive SHA256 is `50fcaca982b010536fd5cac774566262addd857ec013ae0781b8a4e61ac71740`. At 05:03 America/Toronto, training had reached 56,270 updates, consumed 57,620,480 unique proteins without repeats, and averaged 0.2115 seconds per update over the preceding 1,000 updates; the latest rolling checkpoint was at 56k. The estimated endpoint remains approximately 87k updates at the unchanged 07:04 training deadline, including observed evaluation overhead; the [05:03 monitor snapshot](evidence/STATUS_20260914T0902Z.json) records the throughput-based estimate separately from completed results.
