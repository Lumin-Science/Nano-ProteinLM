...
loss. See the [completed Fir comparison and detailed explanation](../../../docs/leaderboard/nanop-best-171m-round1.md)
...
See [checkpoint continuation](../../../docs/USAGE.md#training).
