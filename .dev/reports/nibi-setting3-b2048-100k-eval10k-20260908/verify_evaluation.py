...
NAME = "nibi-setting3-b2048-100k-eval10k-20260908"
REMOTE = Path("/scratch/muchenli/Nano-Protein-LM-nibi-setting3-b2048-100k-eval10k-20260908")
...
frozen_config = subprocess.check_output(
    ["git", "show", f"{SOURCE}:configs/esmc-171m-setting3-nibi-fa3-b2048-stage1-100k.yaml"],
    cwd=REPO,
)
