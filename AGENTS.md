...
- `.dev/scripts/build_clean_starter.py` builds the released starter (`autoresearch-v*` tags). Never let it ship improvements or prior findings.
...
- [.dev/AI_REVIEW.md](.dev/AI_REVIEW.md) has the full conventions. Keep each Markdown or LaTeX prose paragraph on one source line.
