...
class TrainingDataContractTests(unittest.TestCase):
    ...
    def test_sixteen_hour_campaign_is_step_and_homology_gated(self) -> None:
        ...
        self.assertTrue(config["require_homology_exclusion"])
