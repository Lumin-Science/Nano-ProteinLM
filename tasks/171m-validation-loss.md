...
- **Score:** held-out sequence-mean MLM negative log-likelihood, **lower is better**. Read `validation_mlm.sequence_mean_nll` from the run's `evaluation/EVALUATION.json`. Contact P@L is a diagnostic.
