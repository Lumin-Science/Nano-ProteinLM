# Retired training launchers

These scripts are preserved byte-for-byte from commit `f1a828e` as historical
records. Their paths and environment interfaces belong to that checkout; use
