...
repo_root=/scratch/muchenli/Nano-Protein-LM-nibi-b2048-100k-eval10k-20260908-run
cd "$repo_root"
...
run_python=/scratch/muchenli/Nano-Protein-LM-nibi-b2048-100k-eval10k-20260908/runtime/.venv/bin/python
cache_args=()
